...
public class Slider extends FrameLayout {
      ...
      try {
        config =
            new Config.Builder(getContext())
                .animateIndicators(
                    typedArray.getBoolean(R.styleable.Slider_slider_animateIndicators, true))
                .emptyView(
                    typedArray.getResourceId(
                        R.styleable.Slider_slider_emptyView, Config.NOT_SELECTED))
                .indicatorSize(
                    typedArray.getDimensionPixelSize(R.styleable.Slider_slider_indicatorSize, 0))
                ...
                .selectedSlideIndicator(
                    typedArray.getDrawable(R.styleable.Slider_slider_selectedSlideIndicator))
                .unselectedSlideIndicator(
                    typedArray.getDrawable(R.styleable.Slider_slider_unselectedSlideIndicator))
                .hideIndicators(
                    typedArray.getBoolean(R.styleable.Slider_slider_hideIndicators, false))
                .build();
      } catch (Exception e) {
  ...
  private void setupSlideIndicator() {
    if (!config.hideIndicators) {
      slideIndicatorsGroup =
          new SlideIndicatorsGroup(
              getContext(),
  ...
  public void onImageSlideChange(int position) {
    ...
    if (slideIndicatorsGroup != null) slideIndicatorsGroup.onSlideChange(userSlidePosition);
  ...
  public void setScrollEffectEnabled(boolean enable) {
    this.hasScrollEffect = enable;
  }
  ...
  public void setOnSlideClickListener(OnSlideClickListener onSlideClickListener) {
    ...
    if (adapter != null) adapter.setOnSlideClickListener(onSlideClickListener);
  }
  ...
  public void setAdapter(SliderAdapter sliderAdapter) {
    if (sliderAdapter != null && recyclerView != null) {
      ...
      SsSnapHelper snapHelper =
          new SsSnapHelper(
              new SsSnapHelper.OnSelectedItemChange() {
                @Override
  ...
  public static ImageLoadingService getImageLoadingService() {
    if (imageLoadingService == null) {
      throw new IllegalStateException(
          "ImageLoadingService is null, you should call init method first");
    }
                        ...
                        if (currentView != null) {
                          Animator set =
                              AnimatorInflater.loadAnimator(
                                  getContext(), R.animator.fade_out_animator);
                          set.setTarget(currentView);
                          set.addListener(
                          ...
                          recyclerView.scrollToPosition(nextSlidePosition);
                        }
                      } else {
                        recyclerView.scrollToPosition(nextSlidePosition);
                      }
  ...
  public void setAnimateIndicators(boolean shouldAnimate) {
    ...
    if (slideIndicatorsGroup != null) slideIndicatorsGroup.setMustAnimateIndicators(shouldAnimate);
  }

  public void hideIndicators() {
    config.hideIndicators = true;
    if (slideIndicatorsGroup != null) slideIndicatorsGroup.setVisibility(GONE);
  }

  public void showIndicators() {
    config.hideIndicators = false;
    if (slideIndicatorsGroup != null) slideIndicatorsGroup.setVisibility(VISIBLE);
  }
  ...
  public void setIndicatorStyle(int indicatorStyle) {
    switch (indicatorStyle) {
      case IndicatorShape.CIRCLE:
        config.selectedSlideIndicator =
            ContextCompat.getDrawable(getContext(), R.drawable.indicator_circle_selected);
        config.unselectedSlideIndicator =
            ContextCompat.getDrawable(getContext(), R.drawable.indicator_circle_unselected);
        break;
      case IndicatorShape.SQUARE:
        config.selectedSlideIndicator =
            ContextCompat.getDrawable(getContext(), R.drawable.indicator_square_selected);
        config.unselectedSlideIndicator =
            ContextCompat.getDrawable(getContext(), R.drawable.indicator_square_unselected);
        break;
      case IndicatorShape.DASH:
        config.selectedSlideIndicator =
            ContextCompat.getDrawable(getContext(), R.drawable.indicator_dash_selected);
        config.unselectedSlideIndicator =
            ContextCompat.getDrawable(getContext(), R.drawable.indicator_dash_unselected);
        break;
      case IndicatorShape.ROUND_SQUARE:
        config.selectedSlideIndicator =
            ContextCompat.getDrawable(getContext(), R.drawable.indicator_round_square_selected);
        config.unselectedSlideIndicator =
            ContextCompat.getDrawable(getContext(), R.drawable.indicator_round_square_unselected);
        break;
    }
